...
const ProductDetailPage = () => {
  ...
  const userId =
    useSelector((state) => state.loginSlice.id) || getUserIdCookie();

  // Redux에서 공연 상세 정보 가져오기
  const { festivalDetails, totalStar, placeLocation } = useSelector(
    (state) => state.detail
  );
            ...
            <div className="Information_TopHeader">
              ...
              <div className="Information_Rating">
                ...
                <Rating
                  ...
                  readOnly
                />
                <span className="Information_RatingScore">
            ...
            <div className="Information_Body">
              <div className="Information_PosterBox">
                <div className="Information_PosterBoxTop">
                  <img
                    src={postImage}
                    className="Information_PosterBoxImage"
                    alt="연극 이미지"
                  />
                </div>
              ...
              <ul className="Information_Info">
                <li className="Information_InfoItem">
                  ...
                  <p
                    className="Information_InfoDesc clickable-text"
                    onClick={toggleMap}
                  >
                ...
                <li className="Information_InfoItem">
                  ...
                  <p className="Information_InfoDesc">
                    전석 {festivalPrice.toLocaleString()}원
                  </p>
                </li>
                <li className="Information_InfoItem">
          ...
          <div className="Calendar_Sticky">
                        ...
                        festivalTimeData.map((time, index) => (
                          <li key={index} className="Calendar_TimeTableItem">
                            <button
                              ...
                              onClick={() =>
                                handleTimeClick(time.time, time.dateId)
                              } // ✅ dateId 전달 확인!
                            >
                              {`${index + 1}회 ${time.time}`}
                            </button>
            ...
            <button
              className={`Reservation_Button ${
                isButtonEnabled ? "active" : "disabled"
              }`}
