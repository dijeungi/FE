                ...
                <div className="SearchPw2-h2_box">
                    <div>
                        <Link to="/account/findId">
                            <h2 className="SearchPw2-h2-1">아이디 찾기</h2>
                        </Link>
                    </div>
                    <div>
                        <Link to="/account/findPassword">
                            <h2 className="SearchPw2-h2-2">비밀번호 찾기</h2>
                        </Link>
                    </div>
                </div>
                <input type="radio" name="SearchPw2" className="Search-chk" />
                <label>휴대폰 번호인증으로 찾기</label>
                <p className="Searchpw2_text">
