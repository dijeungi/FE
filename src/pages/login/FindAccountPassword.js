    ...
    return (
        <>
            <div className="SearchPw-wrap">
                <h1>비밀번호 찾기</h1>
                <div className="SearchPw-h2_box">
                    <div>
                        <Link to="/account/findId">
                            <h2 className="SearchPw-h2-1">아이디 찾기</h2>
                        </Link>
                    </div>
                    <div>
                        <Link to="/account/findPassword">
                            <h2 className="SearchPw-h2-2">비밀번호 찾기</h2>
                        </Link>
                    </div>
                </div>
                ...
                <Link to="/account/findPassword/detail">
                    <input type="button" value="아이디 확인" className="SearchPw-button" />
                </Link>
            </div>
        </>
    );
