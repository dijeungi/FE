...
// 슬라이드 이미지 데이터 및 배경색
const images = [
    { src: "https://image.toast.com/aaaaab/ticketlink/TKL_7/PC_BigBanner_2%EC%9B%94%EB%A7%81%ED%81%AC%ED%94%BD.jpg", backgroundColor: "rgb(255, 202, 220)" },
    { src: "https://image.toast.com/aaaaab/ticketlink/TKL_1/PC_BigBanner_2025SoundberryTheater.jpg", backgroundColor: "rgb(245, 235, 208)" },
    { src: "https://image.toast.com/aaaaab/ticketlink/TKL_10/PC_BigBanner_%EC%A7%80%ED%82%AC%EC%95%A4%ED%95%98%EC%9D%B4%EB%93%9C.jpg", backgroundColor: "rgb(5, 6, 20)" },
    { src: "https://image.toast.com/aaaaab/ticketlink/TKL_8/PC_BigBanner_%EB%82%98%EC%83%81%ED%98%84%EC%94%A8%EB%B0%B4%EB%93%9C.jpg", backgroundColor: "rgb(242, 242, 242)" },
    { src: "https://image.toast.com/aaaaab/ticketlink/TKL_9/PC_BigBanner_%EC%84%B1%EC%9B%85.jpg", backgroundColor: "rgb(18, 18, 18)" },
    { src: "https://image.toast.com/aaaaab/ticketlink/TKL_10/PC_BigBanner_%EC%97%B0%EA%B7%B9%EA%BD%83%EC%9D%98%EB%B9%84%EB%B0%80_0107.jpg", backgroundColor: "rgb(255, 236, 56)" },
    { src: "https://image.toast.com/aaaaab/ticketlink/TKL_4/PC_BigBanner_%EC%96%B4%EC%8D%B8%EB%B6%80%EC%82%B0.jpg", backgroundColor: "rgb(6, 10, 16)" },
    { src: "https://image.toast.com/aaaaab/ticketlink/TKL_1/PC_BigBanner_%EB%AA%85%EC%84%B1%ED%99%A9%ED%9B%84(1).jpg", backgroundColor: "rgb(143, 24, 35)" },
    { src: "https://image.toast.com/aaaaab/ticketlink/TKL_5/PC_BigBanner_%EB%B9%84%EC%97%94%EB%82%981900.jpg", backgroundColor: "rgb(212, 211, 207)" },
    { src: "https://image.toast.com/aaaaab/ticketlink/TKL_4/PC_BigBanner_%EC%84%9C%EC%9A%B8%EC%BB%A4%ED%94%BC%EC%97%91%EC%8A%A4%ED%8F%AC.jpg", backgroundColor: "rgb(252, 247, 243)" }
];
...
export default function MainBanner() {
    const [isPlaying, setIsPlaying] = useState(true);  // 자동 재생 상태 관리
