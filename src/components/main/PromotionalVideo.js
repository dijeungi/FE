                ...
                <div role="presentation" className="CategoryVideo_Category">
                    <menu className="CategoryVideo_Menu">
                        <div className="CategoryVideo__Wrapper">
                            <button className="CategoryVideo_Button" name="추천영상" title="선택됨">
                                추천영상
                            </button>
                        </div>
                        <div className="CategoryVideo__Wrapper">
                            <button className="CategoryVideo_Button" name="뮤지컬" title="">
                                뮤지컬
                            </button>
                        </div>
                        <div className="CategoryVideo__Wrapper">
                            <button className="CategoryVideo_Button" name="콘서트" title="">
                                콘서트
                            </button>
                        </div>
                        <div className="CategoryVideo__Wrapper">
                            <button className="CategoryVideo_Button" name="전시/행사" title="">
                                전시/행사
                            </button>
                        </div>
                        <div className="CategoryVideo__Wrapper">
                            <button className="CategoryVideo_Button" name="클래식/무용" title="">
                                클래식/무용
                            </button>
                        </div>
                        <div className="CategoryVideo__Wrapper">
                            <button className="CategoryVideo_Button" name="아동/가족" title="">
                                아동/가족
                            </button>
                        </div>
                        <div className="CategoryVideo__Wrapper">
                            <button className="CategoryVideo_Button" name="연극" title="">
                                연극
                            </button>
                        </div>
                    </menu>
                ...
                <div className="interpark-play_swiperWrap__jYOxg">
                    ...
                    >
                        {groupedData.map((group, index) => (
                            <SwiperSlide
                                key={index}
                                className="swiper-slide interpark-play_subWrap__JD4Ko swiper-slide-active"
                            >
                                <div
